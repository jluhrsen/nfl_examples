...
from nfl_team_example_stats import *
import objgraph
...
class nfl_team_season_history(object):
    ...
    def get_games_up_to_specific_week(self, team, season, week):
        ...
        for game in season_schedule:
            if self.teamPlayedGame(team, game) and week >= int(game['Week']):
                game_list.append(game)
        return game_list

    def teamPlayedGame(self, team, game):
    ...
    def calculate_averages(self, team, game_list):
